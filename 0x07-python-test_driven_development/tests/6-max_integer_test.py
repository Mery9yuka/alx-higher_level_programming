...
class TestMaxInteger(unittest.TestCase):
    """Defining unittests module  for max_integer([..])."""

    def test_ordered_list(self):
        """Testing an ordered list of ints."""
        ordered = [1, 2, 3, 4]
        self.assertEqual(max_integer(ordered), 4)

    def test_unordered_list(self):
        """Testing an unordered list of ints."""
        unordered = [1, 2, 4, 3]
    ...
    def test_one_element_list(self):
        """Testing a list with a one elemet."""
        one_element = [7]
